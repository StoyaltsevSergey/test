              ...
              <table id="images<?php echo $language['language_id']; ?>" class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                  ...
                  <tr id="image-row<?php echo $image_row; ?>">
                   <td class="text-left" style="width: 25%;"><input type="text" name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][header]" value="<?php echo $banner_image['header']; ?>" placeholder="<?php echo $entry_header; ?>" class="form-control" /></td>
                    <td class="text-left" style="width: 25%;"><input type="text" name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][title]" value="<?php echo $banner_image['title']; ?>" placeholder="<?php echo $entry_title; ?>" class="form-control" />
...
function addImage(language_id) {
    ...
    html += '  <td class="text-left"><input type="text" name="banner_image[' + language_id + '][' + image_row + '][header]" value="" placeholder="<?php echo $entry_header; ?>" class="form-control" /></td>';	
